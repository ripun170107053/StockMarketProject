...
//                        int sez=Integer.parseInt(se);
        ...
        for(int i=0;i<companyCode.size();i++)
        {
            ...
            PreparedStatement st = connect.prepareStatement("INSERT INTO stock_price_entity(stockmarketcharting.stock_price_entity.company_code, " +
                    "stockmarketcharting.stock_price_entity.current_price," +
                    "stockmarketcharting.stock_price_entity.date," +
                    "stockmarketcharting.stock_price_entity.stock_exchange," +
                    "stockmarketcharting.stock_price_entity.time)" + " values (?,?,?,?,?)",Statement.RETURN_GENERATED_KEYS);
